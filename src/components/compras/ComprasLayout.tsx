...
import { COMPRAS_ITEMS, COMPRAS_ICONS } from "./nav-items";
  ...
  return (
    <div className="mx-auto flex max-w-7xl gap-8 px-6 py-12">
      <aside className="w-64 shrink-0 space-y-6">
        ...
        <div>
          <p className="mb-3 font-mono text-[11px] uppercase tracking-widest text-steel">Compras</p>
          <nav className="space-y-1">
            {COMPRAS_ITEMS.map((item, i) => {
              const Icon = COMPRAS_ICONS[i];
              const isPurchasesPath = pathname === "/dashboard/compras";
